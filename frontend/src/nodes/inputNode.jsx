...
export const InputNode = ({ id, data, selected }) => {
  ...
  return (
    <div className={`bg-white rounded-lg shadow-soft border-2 transition-all duration-200 ${
      ...
      {/* Header */}
      <div className="flex items-center space-x-2 px-4 py-3 bg-blue-50 rounded-t-lg border-b border-gray-100">
        <div className="w-6 h-6 bg-blue-500 rounded flex items-center justify-center">
          <Database className="w-3 h-3 text-white" />
        </div>
        <span className="font-medium text-gray-900 text-sm">Input Node</span>
      </div>
